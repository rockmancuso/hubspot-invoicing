...
const config = {
  ...
  HUBSPOT_MANUFACTURER_SALES_VOLUME_PROPERTY: process.env.HUBSPOT_MANUFACTURER_SALES_VOLUME_PROPERTY || 'manufacturer_annual_sales_volume',
  ...
  // Manufacturer Pricing Tiers (Example: store as JSON string in env var or individual vars)
  // MANUFACTURER_PRICING_TIERS could be: '[{"maxSales": 5000000, "fee": 1500}, ...]'
  MANUFACTURER_PRICING_TIERS: JSON.parse(process.env.MANUFACTURER_PRICING_TIERS || `[
    {"maxSales": 5000000, "fee": 1500},
    {"maxSales": 10000000, "fee": 3500},
    {"maxSales": 20000000, "fee": 5000},
    {"maxSales": 40000000, "fee": 7500},
    {"maxSales": Infinity, "fee": 10000}
  ]`),
